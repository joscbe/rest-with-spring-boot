package br.com.joscbe.unitetest.mapper;
...
import br.com.joscbe.unitetest.mapper.mocks.MockPerson;
...
public class ObjectMapperTests {
    ...
    public void parseEntityToDTOTest() {
        ...
        assertEquals("Address Test0", output.getAddres());
    ...
    public void parseEntityListToDTOListTest() {
        ...
        assertEquals("Address Test0", outputZero.getAddres());
        ...
        assertEquals("Address Test7", outputSeven.getAddres());
        ...
        assertEquals("Address Test12", outputTwelve.getAddres());
